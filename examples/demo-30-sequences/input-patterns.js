 ...
 */
export function generateInputVectors() {
    const vectors = [];
 ...
 */
function generateNormalVectors(count) {
    const vectors = [];
 ...
 */
function generateWarningVectors(count) {
    const vectors = [];
    const patterns = [
 ...
 */
function generateCriticalVectors(count) {
    const vectors = [];
    const patterns = [
 ...
 */
function generateOptimizationVectors(count) {
    const vectors = [];
    const patterns = [
 ...
 */
function generateMaintenanceVectors(count) {
    const vectors = [];
    const patterns = [
 ...
 */
function generateEmergencyVectors(count) {
    const vectors = [];
    const patterns = [
 ...
 */
function generateAnomalyVectors(count) {
    const vectors = [];
    for (let i = 0; i < count; i++) {
 ...
 */
export function getInputVectorColor(type) {
    const colorMap = {
        normal: '#22c55e', // Green
...
//# sourceMappingURL=input-patterns.js.map