...
// ============= CATEGORY 1: Environmental Monitoring (5 sequences) =============
function generateEnvironmentalSequences() {
    const sequences = [];
    ...
    const weatherNormal = new RealityVector(Array(3).fill(null).map(() => ({ value: 0.5, comparatorType: ComparatorType.THRESHOLD, threshold: 0.2 })), true);
    ...
    const energyLow = new RealityVector([{ value: 0.3, comparatorType: ComparatorType.THRESHOLD, threshold: 0.1 }], true);
    ...
    const waterNormal = new RealityVector(Array(4).fill(null).map(() => ({ value: 0.5, comparatorType: ComparatorType.THRESHOLD, threshold: 0.15 })), true);
...
// ============= CATEGORY 2: Industrial Process Control (5 sequences) =============
function generateIndustrialSequences() {
    const sequences = [];
    ...
    for (let i = 0; i < 4; i++) {
        ...
        const vec = new RealityVector(Array(3).fill(null).map(() => ({ value: 0.5, comparatorType: ComparatorType.THRESHOLD, threshold: 0.15 })), true);
...
// ============= CATEGORY 3: Healthcare & Biometrics (4 sequences) =============
function generateHealthcareSequences() {
    const sequences = [];
    ...
    for (let i = 0; i < 3; i++) {
        const seq = new CriticalEventSequence(names[i]);
        const vec = new RealityVector(Array(4).fill(null).map(() => ({ value: 0.5, comparatorType: ComparatorType.THRESHOLD, threshold: 0.2 })), true);
...
// ============= CATEGORY 4: Security & Access Control (4 sequences) =============
function generateSecuritySequences() {
    const sequences = [];
    ...
    for (let i = 0; i < 3; i++) {
        const seq = new CriticalEventSequence(names[i]);
        const vec = new RealityVector(Array(3).fill(null).map(() => ({ value: 0.5, comparatorType: ComparatorType.THRESHOLD, threshold: 0.2 })), true);
...
// ============= CATEGORY 5: Financial & Trading (4 sequences) =============
function generateFinancialSequences() {
    const sequences = [];
    ...
    for (let i = 0; i < 4; i++) {
        const seq = new CriticalEventSequence(names[i]);
        const vec = new RealityVector(Array(5).fill(null).map(() => ({ value: 0.5, comparatorType: ComparatorType.THRESHOLD, threshold: 0.15 })), true);
...
// ============= CATEGORY 6: Smart City Infrastructure (4 sequences) =============
function generateSmartCitySequences() {
    const sequences = [];
...
// ============= CATEGORY 7: Communication & Network (4 sequences) =============
function generateNetworkSequences() {
    const sequences = [];
